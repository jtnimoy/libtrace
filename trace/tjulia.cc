...
complex<double> TJulia::function(complex<double> x) const
{
 complex<double> b(1.0, 0.16);
 return (b*sin(x));
 //SHOULD_NOT_GET_HERE
 return x;
}
...
{
 complex<double> x(pos.x,pos.y);
 int iter=0;
 double mag;

#warning TODO: implement "plug-in" system for julia functions 
